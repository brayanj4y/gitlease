...
interface BrutalistDatePickerProps extends React.InputHTMLAttributes<HTMLInputElement> {
  value: string
  onChange: (date: string) => void
  variant?: "blue" | "red" | "yellow" | "green"
}

export const BrutalistDatePicker = forwardRef<HTMLInputElement, BrutalistDatePickerProps>(
  ({ className, value, onChange, variant = "blue", ...props }, ref) => {
